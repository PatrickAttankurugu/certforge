...
-- IAM
('secure', 'iam_policies', 2, 'Which IAM policy type is attached directly to an IAM user, group, or role?',
 'single',
...
('secure', 'iam_policies', 3, 'A company wants to allow an EC2 instance to read objects from an S3 bucket without storing credentials on the instance. What is the MOST secure approach?',
 'single',
...
('secure', 'iam_policies', 4, 'A company has multiple AWS accounts under AWS Organizations. They need to ensure no account can launch EC2 instances larger than m5.xlarge. What should they use?',
 'single',
...
('secure', 'iam_policies', 5, 'A financial services company requires that all API calls to their production AWS account must originate from their corporate network (CIDR: 10.0.0.0/8) or from specific VPCs. Developers also need console access from the corporate network. Which combination provides this restriction while maintaining least privilege? (Select TWO)',
 'multi',
...
-- VPC & Networking
('secure', 'vpc_design', 2, 'What is the primary purpose of a Network Access Control List (NACL) in a VPC?',
 'single',
...
('secure', 'vpc_design', 3, 'A solutions architect needs to design a VPC where web servers in public subnets can communicate with database servers in private subnets. The database servers must not be accessible from the internet. Which configuration achieves this?',
 'single',
...
('secure', 'vpc_design', 4, 'A company needs private connectivity between their VPC and Amazon S3 without traffic traversing the internet. They also need to apply bucket policies that restrict access to the VPC. What should they configure?',
 'single',
...
('secure', 'vpc_design', 5, 'A multinational company has VPCs in us-east-1, eu-west-1, and ap-southeast-1. They need all VPCs to communicate with each other, with centralized traffic inspection. Which architecture is MOST scalable?',
 'single',
...
-- Encryption
('secure', 'encryption', 2, 'Which AWS service is used to create and manage encryption keys for encrypting data at rest?',
 'single',
...
('secure', 'encryption', 3, 'A company requires server-side encryption for all objects uploaded to an S3 bucket. They want to use keys managed by AWS. Which encryption option should they configure?',
 'single',
...
('secure', 'encryption', 4, 'A healthcare company stores PHI (Protected Health Information) in S3. They need to ensure encryption keys are rotated annually, and they must have the ability to audit key usage. Which approach meets these requirements?',
 'single',
...
-- Security Services
('secure', 'security_services', 2, 'Which AWS service automatically discovers and helps protect sensitive data such as PII stored in S3?',
 'single',
...
('secure', 'security_services', 3, 'A company needs to detect unusual API activity and potential threats in their AWS account. Which service should they enable?',
 'single',
...
('secure', 'security_services', 4, 'A web application hosted on ALB is experiencing SQL injection and cross-site scripting attacks. Which combination provides protection?',
 'single',
...
('secure', 'iam_policies', 3, 'Which feature allows you to set the maximum permissions that an IAM entity can have, regardless of identity-based policies?',
 'single',
...
('secure', 'vpc_design', 3, 'What is the MOST cost-effective way to allow instances in a private subnet to download software updates from the internet?',
 'single',
...
('secure', 'data_protection', 3, 'A company wants to store database credentials securely and have them automatically rotated every 30 days. Which service should they use?',
 'single',
...
('secure', 'data_protection', 4, 'A company needs to ensure that an S3 bucket can only be accessed by CloudFront distributions and never directly. What should they configure?',
 'single',
...
('secure', 'security_services', 5, 'A company''s security team needs a centralized view of security findings across multiple AWS accounts and services (GuardDuty, Inspector, Macie, IAM Access Analyzer). Which service provides this?',
 'single',
...
('secure', 'vpc_design', 4, 'A company needs to inspect all traffic between VPCs for intrusion detection. Which AWS service provides managed network traffic inspection?',
 'single',
...
('secure', 'iam_policies', 4, 'A developer needs temporary access to a production S3 bucket to debug an issue. The access should expire after 1 hour. What is the best approach?',
 'single',
...
('secure', 'encryption', 3, 'Which encryption approach should be used when a company must manage its own encryption keys but wants S3 to perform the encryption?',
 'single',
...
('secure', 'vpc_design', 2, 'Which component is required to allow resources in a VPC to communicate with the internet?',
 'single',
...
('secure', 'security_services', 3, 'Which AWS service provides DDoS protection for resources behind CloudFront and ALB?',
 'single',
...
('secure', 'data_protection', 2, 'What is the simplest way to encrypt an existing unencrypted EBS volume?',
 'single',
...
('secure', 'iam_policies', 5, 'A company uses federated access with SAML 2.0 to allow employees to access the AWS Management Console. They want to ensure that federated users can only assume roles in their respective department OUs. Which approach is MOST secure?',
 'single',
...
('secure', 'vpc_design', 3, 'What is the difference between a security group and a NACL?',
 'single',
...
('resilient', 'ha_design', 2, 'What is the primary benefit of deploying an application across multiple Availability Zones?',
 'single',
...
('resilient', 'ha_design', 3, 'A company wants to ensure their web application can survive an AZ failure. The application runs on EC2 instances behind an ALB. What is the minimum architecture?',
 'single',
...
('resilient', 'ha_design', 4, 'A critical application requires an RPO of 15 minutes and an RTO of 1 hour. The application uses RDS MySQL. Which disaster recovery strategy is MOST cost-effective?',
 'single',
...
('resilient', 'ha_design', 5, 'A global e-commerce company needs their application to remain available even if an entire AWS Region goes down. The application uses a relational database. Which architecture provides the LOWEST RTO?',
 'single',
...
-- Decoupling
('resilient', 'decoupling', 2, 'Which AWS service provides a fully managed message queue for decoupling application components?',
 'single',
...
('resilient', 'decoupling', 3, 'A company processes orders asynchronously. They need to ensure that each order is processed exactly once, even if the processing fails and the message is retried. Which SQS feature should they use?',
 'single',
...
('resilient', 'decoupling', 4, 'A microservices architecture needs to fan out a single event to multiple subscriber services. Each subscriber processes the event independently. What is the recommended pattern?',
 'single',
...
('resilient', 'decoupling', 5, 'A company needs to process events from multiple sources (S3, API Gateway, CloudTrail) with different routing rules to different targets (Lambda, Step Functions, SQS). Events must be filtered by content. Which service is MOST appropriate?',
 'single',
...
-- Backup & Recovery
('resilient', 'backup_recovery', 3, 'A company needs a unified backup solution across EC2, RDS, DynamoDB, and EFS. Which service should they use?',
 'single',
...
('resilient', 'backup_recovery', 4, 'A company has an RPO of zero for their Aurora database. Which feature provides this?',
 'single',
...
('resilient', 'ha_design', 3, 'Which Route 53 routing policy should be used to route traffic to a secondary region when the primary region health check fails?',
 'single',
...
('resilient', 'ha_design', 2, 'Which S3 storage class provides 99.999999999% (11 nines) durability?',
 'single',
...
('resilient', 'decoupling', 3, 'A Lambda function processes messages from an SQS queue. Some messages consistently fail processing. How should the architect handle poison messages?',
 'single',
...
('resilient', 'backup_recovery', 2, 'How often does Amazon RDS create automated backups by default?',
 'single',
...
('resilient', 'ha_design', 4, 'A stateful web application stores session data locally on EC2 instances. The company wants to make the application highly available across multiple AZs. What change is required?',
 'single',
...
('performant', 'compute_selection', 2, 'Which EC2 instance family is optimized for compute-intensive workloads like batch processing and gaming servers?',
 'single',
...
('performant', 'compute_selection', 3, 'A company runs a web application with unpredictable traffic. During peaks, they need up to 100 instances but typically use only 10. They want to minimize costs. Which purchasing option is MOST cost-effective?',
 'single',
...
('performant', 'compute_selection', 4, 'A machine learning training workload requires GPU instances for 4-6 hours at a time. The workload is fault-tolerant and can resume from checkpoints. Which is the MOST cost-effective approach?',
 'single',
...
-- Caching
('performant', 'caching', 2, 'Which service provides an in-memory cache that is compatible with Redis?',
 'single',
...
('performant', 'caching', 3, 'A read-heavy application queries the same DynamoDB items repeatedly. What is the MOST effective way to reduce read latency?',
 'single',
...
('performant', 'caching', 4, 'A company''s website serves static assets (images, CSS, JS) to users worldwide. The origin is an S3 bucket in us-east-1. Users in Asia report slow load times. How should they improve performance?',
 'single',
...
('performant', 'database_performance', 2, 'Which database service is BEST for applications requiring single-digit millisecond latency with key-value access patterns?',
 'single',
...
('performant', 'database_performance', 3, 'An application performs many read queries against an RDS MySQL database, causing high CPU utilization. Write operations are infrequent. How should the architect improve read performance?',
 'single',
...
('performant', 'database_performance', 4, 'A company needs to run complex analytical queries on their operational RDS PostgreSQL database without impacting transactional performance. What should they use?',
 'single',
...
('performant', 'database_performance', 5, 'A global application needs a database with single-digit millisecond reads in all regions, automatic conflict resolution, and 99.999% availability. Data is JSON documents. Which is the BEST choice?',
 'single',
...
-- Storage Performance
('performant', 'storage_performance', 3, 'An application requires a shared file system accessible by multiple EC2 instances across AZs with POSIX compliance. Which storage service should be used?',
 'single',
...
('performant', 'storage_performance', 4, 'A high-performance computing (HPC) application needs a parallel file system with sub-millisecond latencies. Which service is MOST appropriate?',
 'single',
...
('performant', 'networking_performance', 3, 'A company needs to reduce latency for their API served from a single region to global users. Which service can improve performance without deploying to multiple regions?',
 'single',
...
('performant', 'networking_performance', 4, 'A company needs to transfer 50 TB of data from their data center to S3 as quickly as possible. Their internet connection is 1 Gbps. What is the FASTEST approach?',
 'single',
...
('performant', 'compute_selection', 3, 'Which compute service is BEST for running containers without managing servers?',
 'single',
...
('performant', 'compute_selection', 4, 'A company runs short-lived API endpoints (< 15 seconds) with variable traffic from 0 to 10,000 requests per second. Which compute option provides the BEST cost-performance ratio?',
 'single',
...
('performant', 'database_performance', 3, 'Which DynamoDB feature automatically adjusts provisioned capacity based on traffic patterns?',
 'single',
...
('performant', 'caching', 3, 'What is the default TTL for CloudFront cached objects?',
 'single',
...
('performant', 'storage_performance', 2, 'Which EBS volume type provides the highest IOPS performance for transactional databases?',
 'single',
...
('performant', 'networking_performance', 2, 'What does Amazon CloudFront use to serve content closer to users?',
 'single',
...
-- Storage Costs
('cost', 'storage_costs', 2, 'Which S3 storage class is the LEAST expensive for data that is rarely accessed but needs immediate retrieval?',
 'single',
...
('cost', 'storage_costs', 3, 'A company stores 100 TB of log data in S3 Standard. Logs older than 30 days are rarely accessed, and logs older than 1 year are needed only for compliance (accessed less than once per year). Which lifecycle policy minimizes costs?',
 'single',
...
('cost', 'storage_costs', 4, 'A data lake in S3 has millions of objects with varying access patterns. Some objects are accessed frequently, others rarely. The access patterns are unpredictable. Which storage class minimizes costs without manual management?',
 'single',
...
-- Database Costs
('cost', 'database_costs', 3, 'A startup runs a MySQL database on RDS. Usage is unpredictable with periods of zero activity. Which RDS option minimizes costs?',
 'single',
...
('cost', 'database_costs', 4, 'A company''s DynamoDB table has a consistent baseline of 1000 WCU with occasional spikes to 5000 WCU. How should they optimize costs?',
 'single',
...
('cost', 'architecture_optimization', 3, 'Which AWS service helps identify underutilized EC2 instances and provides rightsizing recommendations?',
 'single',
...
('cost', 'architecture_optimization', 4, 'A company runs a monolithic application on a large EC2 instance (r5.4xlarge). The application has three components with different scaling needs: an API (CPU-bound), a queue processor (memory-bound), and a scheduler (minimal resources). How should they restructure for cost optimization?',
 'single',
...
('cost', 'architecture_optimization', 5, 'A company processes real-time IoT data from 100,000 sensors. They currently use Kinesis Data Streams (100 shards) → Lambda → DynamoDB. Monthly costs are $15,000. The data can tolerate 5-minute processing delays. How can they reduce costs? (Select TWO)',
 'multi',
...
('cost', 'storage_costs', 2, 'What is the CHEAPEST S3 storage class for long-term archival data that can tolerate 12-hour retrieval times?',
 'single',
...
('cost', 'database_costs', 2, 'Which RDS feature helps reduce read-heavy database costs by offloading reads?',
 'single',
...
('cost', 'architecture_optimization', 3, 'A company wants to be alerted when their monthly AWS spending exceeds $10,000. Which service should they use?',
 'single',
...
('cost', 'storage_costs', 3, 'A company uploads 10,000 small files (1 KB each) to S3 daily. They noticed high costs despite low storage volume. Why?',
 'single',
...
('cost', 'architecture_optimization', 4, 'A company runs a data pipeline: S3 → Lambda (transforms) → RDS (stores). Lambda functions run for 10-15 minutes and frequently hit the 15-minute timeout. What change reduces costs AND eliminates timeouts?',
 'single',
...
('cost', 'database_costs', 4, 'A company uses RDS PostgreSQL (db.r5.2xlarge) with 20% average CPU utilization. What is the FIRST step to reduce costs?',
 'single',
...
('cost', 'architecture_optimization', 5, 'A media company stores 500 TB of video files in S3 Standard. 90% of videos are accessed within the first week of upload, then rarely after. They want to minimize storage costs while keeping all content accessible within minutes. Which combination is MOST cost-effective?',
 'single',
