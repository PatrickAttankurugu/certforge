  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <LandingAnimations>
        ...
        <section className="py-12 sm:py-16 px-4 border-t" id="pricing" data-animate="section">
          <div className="max-w-4xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-4 text-sm">
              <Link href="/guarantee" className="text-primary hover:underline underline-offset-2 font-medium">
                Pass Guarantee &rarr;
              </Link>
              <Link href="/teams" className="text-primary hover:underline underline-offset-2 font-medium">
                Team Plans &rarr;
              </Link>
              <Link href="/lifetime" className="text-primary hover:underline underline-offset-2 font-medium">
                Lifetime Access &rarr;
              </Link>
            </div>
          </div>
        </section>
        ...
        {/* ─── Pass Guarantee ─── */}
        <section className="py-10 sm:py-12 px-4 border-t bg-primary/5" data-animate="section">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            <div className="flex items-center justify-center gap-2">
              <Shield className="h-6 w-6 text-primary" />
              <h2 className="text-lg sm:text-xl font-bold">Pass Guarantee</h2>
            </div>
            <p className="text-sm text-muted-foreground max-w-xl mx-auto">
              Premium members who complete 80%+ of questions and score 600+ on 3 mock exams are
              guaranteed to pass the AWS SAA-C03 — or get a <strong className="text-foreground">full refund</strong>.
            </p>
            <Link href="/guarantee">
              <Button variant="outline" size="sm" className="gap-1">
                Learn About Our Guarantee <ArrowRight className="h-3.5 w-3.5" />
              </Button>
            </Link>
          </div>
        </section>
        ...
        <footer className="border-t py-6 sm:py-8 px-4">
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs text-muted-foreground">
              ...
              <a href="#pricing" className="hover:text-foreground transition-colors">Pricing</a>
              <Link href="/guarantee" className="hover:text-foreground transition-colors">Guarantee</Link>
              <Link href="/teams" className="hover:text-foreground transition-colors">Teams</Link>
              <Link href="/certifications" className="hover:text-foreground transition-colors">Certifications</Link>
              <Link href="/practice-questions" className="hover:text-foreground transition-colors">Free Questions</Link>
            </div>
          </div>
        </footer>
      </LandingAnimations>
